...
s.name = "CarShare"
s.summary = "The CarShare framework helps facilitate BLE communication between mobile devices and Geotab connected vehicles."
s.requires_arc = true
...
s.source = { :git => "https://gitlab.voffice.bsmtechnologies.com/bsm/illuminate/mobile/car-share-framework-podspec.git",
:tag => "#{s.version}" }
