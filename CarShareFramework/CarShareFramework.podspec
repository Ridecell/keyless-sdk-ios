...
s.author = { "Matt Snow" => "matthewsnow@geotab.com" }
...
s.homepage = "https://gitlab.voffice.bsmtechnologies.com/mmaguire/cocoapods-test"
...
s.source = { :git => "https://gitlab.voffice.bsmtechnologies.com/bsm/illuminate/mobile/car-share-ios/tree/il-1306/cocoapod-setup/CarShareFramework.git",
:tag => "#{s.version}" }
